...
Digital Marketing Specialist with 5+ years building and scaling marketing automation, email lifecycle campaigns, and WordPress/LearnDash web platforms for education and B2B/B2C brands. Track record of above-benchmark email engagement (50.78% open rate, 3.83% click rate against industry medians of 33.78% and 1.37%) and of building the WordPress sites, course portals, and REST API integrations that marketing automation runs on. Combines hands-on marketing execution with development skills (PHP, JavaScript, Python, SQL, FastAPI) to bridge marketing and engineering.

**SKILLS**

**Marketing Automation & Lifecycle:** ActiveCampaign, Email Automation, Drip/Nurture Sequences, Re-engagement Campaigns, List Segmentation, Zapier, Webhook Integrations, Funnel & KPI Analysis

**Web & CMS:** WordPress, LearnDash, WooCommerce, Bubble.io, WeWeb, SiteGround (hosting, domain migration), Landing Page Design, REST API Integration
...
* Python Web Scraper (GitHub): Built an automated BeautifulSoup scraper that extracts, cleans, and deduplicates web data, batch-loading results into a Supabase database for analytics.
